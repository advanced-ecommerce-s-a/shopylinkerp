...
*}
{assign var="active" value="register"}

<div class="row register">
    <div class="row">
        <div class="col-md-9">
            <div class="shopyheader">
                <h2>{l s='Register' mod='shopylinkerp'}</h2>
            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="email" title="{l s='Email' mod='shopylinkerp'}"
                                               placeholder="{l s='Email' mod='shopylinkerp'}"
                                               class="form-control smttooltip"
                                               name="email" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" placeholder="{l s='Last name' mod='shopylinkerp'}"
                                               title="{l s='Last name' mod='shopylinkerp'}"
                                               class="form-control smttooltip"
